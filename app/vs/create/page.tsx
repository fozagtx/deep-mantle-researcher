...
import { useMessages, useTranslations } from "@/lib/copy";
...
const getExplorerUrl = () => "https://sepolia.mantlescan.xyz";
...
function draftOutcomeSidesFromQuestion(question: string): { creator: string; opponent: string } | null {
...
export default function CreatePage() {
   ...
   * `useLayoutEffect` aplica antes del pintado.
   */
  useLayoutEffect(() => {
    if (created === null) {
      return;
  ...
  function autofillOutcomeSidesFromQuestion() {
    const drafted = draftOutcomeSidesFromQuestion(question);
    if (!drafted) {
  ...
  useEffect(() => {
    ...
    const normalizedDraftSource = normalizeResolutionSource(rawSourceUrl);
    if (normalizedDraftSource) {
      setUrl(normalizedDraftSource);
      setSourceDraftUrl(normalizedDraftSource);
  ...
  useEffect(() => {
    if (!SOURCE_DRAFTS_ENABLED || !sourceDraftUrl) {
      return;
    }

    void requestSourceDrafts(sourceDraftUrl);
    setSourceDraftUrl("");
  }, [requestSourceDrafts, sourceDraftUrl]);
            ...
            <AnimatedItem>
              <div className="space-y-6 sm:space-y-10">
                ...
                <GlassCard
                  ...
                  noPad
                  glow="none"
                  className="!rounded-2xl !border-[#2670DC]/25 !bg-white"
                >
                ...
                <div>
                  <p className="mb-3 text-center font-mono text-[9px] font-bold uppercase tracking-[0.18em] text-pv-muted/90">
                    {t("shareVia")}
                  </p>
                  <div className="flex flex-wrap justify-center gap-2">
                    <a
                      href={`https://wa.me/?text=${encodeURIComponent(`Challenge me on Branium: ${shareUrl}`)}`}
                      target="_blank"
                ...
                <div className="rounded-xl border border-[#2670DC]/20 bg-[#F4F9FF] px-4 py-3.5 sm:px-5">
    ...
    <>
      ...
      {SOURCE_DRAFTS_ENABLED && (
        <AnimatedItem>
          <GlassCard
            ...
            noPad
            glow="none"
            className="!rounded-2xl !border-[#2670DC]/25 !bg-white w-full overflow-hidden"
          >
            <button
              type="button"
            ...
            >
              <div className="space-y-5 border-t border-[#2670DC]/16 px-6 pb-6 pt-6 sm:px-8 sm:pb-8 sm:pt-6">
                ...
                {draftResult ? (
                  <div className="space-y-4">
                    <div className="rounded-xl border border-[#2670DC]/20 bg-[#F4F9FF] p-4">
                      ...
                      <p className="mt-3 text-sm leading-relaxed text-pv-text">
                      ...
                      {draftResult.candidates.map((candidate, index) => {
                        ...
                        return (
                          <div
                            ...
                            className="rounded-2xl border border-[#2670DC]/20 bg-[#F4F9FF] p-4 sm:p-5"
                          >
                            ...
                            <div className="mt-4 grid gap-3 sm:grid-cols-2">
                              <div className="rounded-xl border border-[#2670DC]/20 bg-white p-3">
                                <div className="text-[10px] font-bold uppercase tracking-[0.14em] text-pv-muted">
                                  {t("sourceDraftSideA")}
                                </div>
                                <div className="mt-2 text-sm font-medium text-pv-text">
                                  {candidate.sideA}
                                </div>
                              </div>
                              <div className="rounded-xl border border-[#2670DC]/20 bg-white p-3">
                            ...
                            <div className="mt-4 grid gap-3 sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
                              <div className="rounded-xl border border-[#2670DC]/20 bg-white p-3">
                                ...
                                <div className="mt-2 text-sm font-medium text-pv-text">
                                  {hasDeadline
                                    ? `${draftDeadline.toLocaleString("en-US", {
                                        year: "numeric",
                                        month: "short",
                                        day: "numeric",
                                        hour: "2-digit",
                              ...
                              <div className="rounded-xl border border-[#2670DC]/20 bg-white p-3">
                                ...
                                <div className="mt-2 break-all text-sm font-medium text-pv-text">
                                  {candidate.primaryResolutionSource}
                                </div>
                              </div>
                            </div>

                            <div className="mt-4 rounded-xl border border-[#2670DC]/20 bg-white p-3">
                              <div className="text-[10px] font-bold uppercase tracking-[0.14em] text-pv-muted">
                                {t("sourceDraftSettlementRule")}
                              </div>
                              <p className="mt-2 text-sm leading-relaxed text-pv-text">
      ...
      <AnimatedItem>
        <GlassCard
          ...
          noPad
          glow="none"
          className="!rounded-2xl !border-[#2670DC]/25 !bg-white w-full"
        >
          <div className="space-y-6 p-6 sm:p-8">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows={5}
                className="min-h-[160px] w-full resize-none rounded-2xl border border-[#2670DC]/40 bg-white p-6 sm:p-8 font-display text-xl leading-snug tracking-tight text-pv-text outline-none transition-all placeholder:text-pv-muted/50 focus:border-[#0044B9]/75 focus:ring-2 focus:ring-[#2670DC]/20 focus:shadow-glow-emerald sm:text-2xl md:text-[26px]"
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
              ...
              <button
                ...
                className="inline-flex shrink-0 items-center justify-center gap-1.5 self-start rounded-md border border-black/[0.1] bg-black/[0.04] px-2.5 py-1.5 text-left text-[11px] font-medium leading-snug text-pv-text transition-colors hover:border-black/[0.16] hover:bg-black/[0.07] disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:border-black/[0.1] disabled:hover:bg-black/[0.04] sm:max-w-[min(100%,15rem)]"
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-0">
              ...
              <div className="relative flex flex-col gap-4 md:pr-4 md:border-r md:border-black/[0.06]">
                ...
                <input
                  type="text"
                  className="relative w-full rounded-xl border border-[#2670DC]/40 bg-white px-4 py-3.5 font-body text-sm text-pv-text outline-none transition-all placeholder:text-pv-muted/90 focus:border-[#0044B9]/75 focus:ring-2 focus:ring-[#2670DC]/20 focus:shadow-glow"
              ...
              <div className="relative flex flex-col gap-4 md:pl-4">
                ...
                <input
                  type="text"
                  className="relative w-full rounded-xl border border-[#2670DC]/40 bg-white px-4 py-3.5 font-body text-sm text-pv-text outline-none transition-all placeholder:text-pv-muted/90 focus:border-[#0044B9]/75 focus:ring-2 focus:ring-[#2670DC]/20 focus:shadow-glow-fuch"
      ...
      <AnimatedItem>
                  ...
                  <button
                    ...
                    className={`flex-1 rounded-lg px-6 py-2.5 font-display text-[11px] font-bold uppercase tracking-[0.18em] transition-[color,background-color,border-color,box-shadow,transform] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pv-emerald/40 focus-visible:ring-offset-2 focus-visible:ring-offset-pv-bg sm:tracking-[0.2em] md:flex-none md:min-w-[9.5rem] ${
                      selected
                        ...
                        : "border border-[#2670DC]/28 bg-white text-pv-muted hover:border-[#2670DC]/45 hover:text-pv-text active:scale-[0.98]"
                    }`}
                  >
                    {t(labelKey)}
                  </button>
                  ...
                  <motion.button
                    ...
                    className={`min-w-0 rounded-lg border px-1.5 py-2 font-display text-[11px] font-bold leading-tight transition-[border-color,background-color,color,box-shadow] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pv-emerald/35 focus-visible:ring-offset-2 focus-visible:ring-offset-pv-bg sm:px-2 sm:py-2.5 sm:text-xs ${
                      stake === amount && presetStakeHighlight
                        ...
                        : "border border-[#2670DC]/28 bg-white text-pv-muted hover:border-[#2670DC]/45 hover:text-pv-emerald"
                    }`}
                  >
                    {amount} MNT
                  </motion.button>
                ...
                <div
                  className={`flex min-h-[2.75rem] w-full min-w-0 items-center justify-center rounded-lg border px-1.5 py-1.5 transition-[border-color,background-color,color,box-shadow] sm:min-h-[3.25rem] sm:px-2 sm:py-2 ${
                    customStakeFocused || !isPresetStakeAmount(stake)
                      ? "border-pv-emerald bg-pv-emerald/[0.12] text-pv-emerald shadow-[0_0_16px_-8px_rgba(216,95,95,0.3)]"
                      : "border border-[#2670DC]/28 bg-white text-pv-muted"
                  }`}
                >
                  <div className="inline-flex max-w-full items-center justify-center gap-0.5 sm:gap-1">
                    <input
                      ...
                      className={`max-w-full shrink-0 bg-transparent font-display text-[11px] font-bold tabular-nums text-inherit outline-none placeholder:text-pv-muted/90 focus:outline-none sm:text-xs [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none ${
                        customStakeDraft.trim() !== ""
                          ? "text-right"
                          : "text-center"
                      }`}
        ...
        <AnimatedItem>
          ...
          >
            <div className="space-y-4 p-6 sm:p-8">
              ...
              <div className="space-y-3 rounded-xl border border-[#2670DC]/20 bg-[#F4F9FF] p-4 sm:p-5">
                ...
                {verificationQuestionHint.trim() !== "" && (
                  <p className="text-xs leading-relaxed text-pv-muted/90">
        ...
        <AnimatedItem>
          ...
          >
            ...
            >
              <div className="space-y-8 border-t border-[#2670DC]/16 px-6 pb-6 pt-6 sm:px-8 sm:pb-8">
          ...
          <aside className="lg:col-span-4 text-pv-text">
            <AnimatedItem>
              <div className="flex flex-col gap-6 lg:sticky lg:top-24">
                ...
                />
                {CLAIM_MODERATION_ENABLED ? (
                  <div className="relative overflow-hidden rounded-2xl border border-[#2670DC]/20 bg-[#F4F9FF] px-3 py-3 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.65)] sm:px-4">
                    <div
                    ...
                    <div className="flex min-w-0 flex-row flex-wrap items-center justify-center gap-5 sm:gap-8">
                      <Button
                        ...
                        className="shrink-0 rounded-lg px-3.5 py-1.5 text-[10px] font-semibold uppercase tracking-[0.12em] !border-black/[0.10] !bg-black/[0.03] !text-pv-muted/95 enabled:hover:!border-black/[0.14] enabled:hover:!bg-black/[0.05] enabled:hover:!text-pv-text/95 disabled:!opacity-50"
                      >
                      ...
                      <div className="min-w-0 shrink-0 text-center">
                        ...
                        <div className="mt-1 font-mono text-xl font-semibold tabular-nums leading-none text-pv-text">
                          {moderationCheckedAtMs ? (
                            <>
                              {Math.max(
                                0,
                              ...
                              <span className="text-base font-medium text-pv-muted/90">
                                /100
                              </span>
                            </>
                          ) : (
                            <>
                              <span className="text-pv-muted/90">—</span>
                              <span className="text-base font-medium text-pv-muted/90">
                                /100
                              </span>
                            </>
                ...
                <p className="text-center text-[9px] font-bold uppercase tracking-widest text-pv-muted/90 leading-snug">
