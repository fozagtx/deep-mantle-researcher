...
import { shouldShowDashboardStakeHoldingsReferences } from "@/lib/dashboardUiPolicy";
...
const dashboardKpiLabelClass =
  "mt-1 font-mono text-[12px] font-bold uppercase tracking-[0.15em] text-pv-muted/90";
...
export default function DashboardPageClient() {
  ...
  const showStakeHoldingsReferences = useMemo(
    () => shouldShowDashboardStakeHoldingsReferences(duels),
    [duels]
  );
              ...
              {snapshotCache && !loadError ? (
                ...
                >
                  ...
                  {snapshotCache.ageMs != null ? (
                    <>
                      {" "}
                      · {formatDashboardSnapshotAge(snapshotCache.ageMs)}
                    </>
                  ) : (
                    <>
                      {" "}
