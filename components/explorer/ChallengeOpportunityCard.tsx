  ...
  return (
    ...
    >
      ...
      <div className="space-y-2.5">
        <h3 className="text-balance font-display text-[1.12rem] font-bold leading-[1.18] tracking-normal text-pv-text sm:text-[1.28rem]">
        ...
        <dl className="grid grid-cols-2 gap-x-4 gap-y-2.5">
          <div className="min-w-0">
            <dt className="inline-flex items-center gap-1.5 font-mono text-[9px] font-bold uppercase tracking-[0.18em] text-pv-muted">
              <Timer size={10} className="shrink-0 text-pv-muted/90" aria-hidden />
          ...
          <div className="min-w-0">
            <dt className="inline-flex items-center gap-1.5 font-mono text-[9px] font-bold uppercase tracking-[0.18em] text-pv-muted">
              <ShieldCheck size={10} className="shrink-0 text-pv-muted/90" aria-hidden />
          ...
          <div className="col-span-2 min-w-0">
            <dt className="inline-flex items-center gap-1.5 font-mono text-[9px] font-bold uppercase tracking-[0.18em] text-pv-muted">
              <Globe size={10} className="shrink-0 text-pv-muted/90" aria-hidden />
