...
export default function GlassCard({
  ...
  const baseClass = glass
    ? "!bg-white !border-[#2670DC]/35 shadow-[0_18px_50px_-32px_rgba(38,112,220,0.48)] border rounded overflow-hidden relative transition-[border-color,background-color,transform,box-shadow] duration-200"
    : "card";
