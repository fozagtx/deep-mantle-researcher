...
export default function SettlementExplanationCard({
  ...
  // This confidence label represents the claim quality score, not on-chain confidence.
        ...
        <div className="space-y-5">
          ...
          {(() => {
            ...
            const cls =
              ...
              isContestedTag || tier === "contested" ? "border-pv-border/60 bg-[#F4F9FF] text-pv-text" :
          ...
          <div className="grid gap-4 lg:grid-cols-[1.3fr_1fr]">
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-black/[0.08] bg-white p-4">
                ...
                <p className="text-sm leading-relaxed text-pv-text">{settlementRule}</p>
