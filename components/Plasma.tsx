...
// 4-stop blue palette (matches the page's pv tokens).
// Index 0 = page bg (lightest), index 3 = accent (deepest tint).
const vec3 PAL0 = vec3(0.969, 0.969, 0.976); // #F7F7F9
const vec3 PAL1 = vec3(0.918, 0.957, 1.000); // #EAF4FF
const vec3 PAL2 = vec3(0.710, 0.835, 1.000); // #B5D5FF
const vec3 PAL3 = vec3(0.149, 0.439, 0.863); // #2670DC
...
void main() {
  ...
  // Map plasma intensity into the blue panel gradient so no value drops to dark.
