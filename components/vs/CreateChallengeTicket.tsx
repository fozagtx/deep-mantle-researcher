...
export default function CreateChallengeTicket({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[#2670DC]/25 bg-white shadow-[0_18px_50px_-34px_rgba(38,112,220,0.42)] transition-all duration-200">
      ...
      <div className="space-y-8 p-6 sm:p-8">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <p className="mt-1 font-mono text-[10px] tracking-[0.12em] text-pv-muted/90">
              <span className="text-pv-muted/90">{t("ticketIdLabel")}</span>{" "}
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2 border-t border-[#2670DC]/16 pt-6">
            <div className="text-[10px] font-bold uppercase tracking-[0.14em] text-pv-muted">
              {t("settlementRule")}
            </div>
            <p className="text-xs italic leading-relaxed text-pv-text/95">
              {showQuoted ? (
                <>
        ...
        <div className="space-y-4 border-t border-dashed border-[#2670DC]/16 pt-6">
      ...
      <div className="flex items-center justify-between gap-3 border-t border-[#2670DC]/20 bg-[#F4F9FF] px-4 py-3">
        ...
        <span className="shrink-0 font-mono text-[10px] text-pv-muted/90">
